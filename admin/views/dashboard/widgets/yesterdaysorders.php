...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="widget">
	<thead>
		<tr>
			<td colspan="5"><h2>Yesterday's Orders</h2></td>
		</tr>
	<?php if ($yesterdaysOrders[0] != ''): ?>
		<tr>
			<th>Customer</th>
	...
	?>
		...
		<tr>
			<td colspan="5"><center>You did not receive any orders yesterday.</center></td>
		</tr>
